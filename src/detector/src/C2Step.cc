...
//
	...
	if (MyParticleDefinition!=NULL)
	{
	    ...
	    else if (MyParticleName=="pi+")		ParticleType= 8;
	    else if (MyParticleName=="pi-")		ParticleType= 9;
	    else if (MyParticleName=="kaon0L")		ParticleType= 10;
	    else if (MyParticleName=="kaon+")		ParticleType= 11;
	    else if (MyParticleName=="kaon-")		ParticleType= 12;
	    else if (MyParticleName=="neutron")		ParticleType= 13;
	    else if (MyParticleName=="proton")		ParticleType= 14;
	    else if (MyParticleName=="anti_proton")	ParticleType= 15;
	    else if (MyParticleName=="kaon0S")		ParticleType= 16;
	    else if (MyParticleName=="anti_neutron")	ParticleType= 25;
	    else if (MyParticleName=="nu_e")		ParticleType= 26;
	    else if (MyParticleName=="nu_mu")		ParticleType= 27;
	    else if (MyParticleName=="nu_tau")		ParticleType= 28;
	    else if (MyParticleName=="anti_nu_e")	ParticleType= 29;
	    else if (MyParticleName=="anti_nu_mu")	ParticleType= 30;
	    else if (MyParticleName=="anti_nu_tau")	ParticleType= 31;
	    else if (MyParticleName=="opticalphoton")	ParticleType= 32;
	    else
	    {
		ParticleType= 33;
...
//
//	    if ((x1[2]<-2.01e3)&&(x1[2]>-2.151e3)&&(fabs(x1[0])<2.75e3)&&(fabs(x1[1])<2.1e4))
	    if (MyPreStepVolumeName=="PlasticPhysical")
	    {
